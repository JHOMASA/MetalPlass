...
data = {
    ...
    "Amount (S/)": [465.80, 5000.00, 500.00, 2000.00, 2500.00, 1800.00, 10.00, 1560.00, 500.00, 1687.00, 10.00, 785.88, 0.00],
...
data1 = {
    ...
    "Enero": [201.40, 373.50, 30601.63, 429.41,5800.00, np.nan],
    "Febrero": [248.50, 527.50, 32538.20, 892.36,5800.00, np.nan],
    "Marzo": [225.00, 709.50, 31485.11, 618.56,5800.00, np.nan],
    "Abril": [248.40, 701.50, 31995.10, 562.32, 5800.00,np.nan],
    "Mayo": [225.00, 474.00, 31378.52, 998.12, 5800.00,np.nan],
    "Junio": [319.00, 309.00, 31485.22,948.91, 5800.00,np.nan],
    "Julio": [630.70, 298.50, 31780.88, 670.72, 5800.00,np.nan],
    "Agosto": [118.90, 314.50, 33128.73,583.41, 5800.00,np.nan],
